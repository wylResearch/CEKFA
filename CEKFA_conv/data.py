...
class load_basedata():
    ...
    def get_train_triples(self,triples_path,entid2clustid,rel2id,id2rel):
        ...
        return np.array(trip_list),rel2id,label_graph, trip_list_without_rev, [label_graph_rt2h, label_graph_ht2r, label_graph_r2ht]
...
class myDataset(Dataset):
    def __init__(self, args, basedata, split):
        self.args = args
